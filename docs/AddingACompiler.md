...
updated in-place when a new patch release comes out (1.24.2 → 1.24.13), while the primary amd64 entries use
version-specific IDs (e.g. `gl1242`, `gl12413`). If you're updating a language that already follows this pattern, it's
fine to continue doing so.
