    ...
    switch (opcode) {
        ...
        case "BXJ":
            return {
                ...
                "html": "<p>Branch and Exchange, previously Branch and Exchange Jazelle.</p><p>In Armv8, <instruction>BXJ</instruction> behaves as a <instruction>BX</instruction> instruction, see <xref linkend=\"A32T32-base.instructions.BX\">BX</xref>. This means it causes a branch to an address and instruction set specified by a register.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "CRC32":
            return {
                ...
                "html": "<p><instruction>CRC32</instruction> performs a cyclic redundancy check (CRC) calculation on a value held in a general-purpose register. It takes an input CRC value in the first source operand, performs a CRC on the input value in the second source operand, and returns the output CRC value. The second source operand can be 8, 16, or 32 bits. To align with common usage, the bit order of the values is reversed as part of the operation, and the polynomial <hexnumber>0x04C11DB7</hexnumber> is used for the CRC calculation.</p><p>In Armv8-A, this is an <arm-defined-word>optional</arm-defined-word> instruction, and in Armv8.1 it is mandatory for all implementations to implement it.</p><p><xref linkend=\"AArch32.id_isar5\">ID_ISAR5</xref>.CRC32 indicates whether this instruction is supported in the T32 and A32 instruction sets.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "DBG":
            return {
                "tooltip": "In Armv8, DBG executes as a NOP. Arm deprecates any use of the DBG instruction.",
                "html": "<p>In Armv8, <instruction>DBG</instruction> executes as a <instruction>NOP</instruction>. Arm deprecates any use of the <instruction>DBG</instruction> instruction.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "DCPS2":
            return {
                ...
                "html": "<p>Debug Change PE State to EL2 allows the debugger to move the PE into EL2 from a lower Exception level.</p><p><instruction>DCPS2</instruction> is <arm-defined-word>undefined</arm-defined-word> if any of:</p><p>When the PE executes <instruction>DCPS2</instruction>:</p><p>For more information on the operation of this instruction, see <xref linkend=\"dcps\">DCPS</xref>.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "DCPS3":
            return {
                ...
                "html": "<p>Debug Change PE State to EL3 allows the debugger to move the PE into EL3 from a lower Exception level or to a specific mode at the current Exception level.</p><p><instruction>DCPS3</instruction> is <arm-defined-word>undefined</arm-defined-word> if any of:</p><p>When the PE executes <instruction>DCPS3</instruction>:</p><p>For more information on the operation of this instruction, see <xref linkend=\"dcps\">DCPS</xref>.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "HVC":
            return {
                "tooltip": "Hypervisor Call causes a Hypervisor Call exception. For more information see Hypervisor Call (HVC) exception.  Non-secure software executing at EL1 can use this instruction to call the hypervisor to request a service.",
                "html": "<p>Hypervisor Call causes a Hypervisor Call exception. For more information see <xref linkend=\"BEIBEBHJ\">Hypervisor Call (HVC) exception</xref>.  Non-secure software executing at EL1 can use this instruction to call the hypervisor to request a service.</p><p>The <instruction>HVC</instruction> instruction is:</p><p>On executing an <instruction>HVC</instruction> instruction, the <xref linkend=\"AArch32.hsr\">HSR, Hyp Syndrome Register</xref> reports the exception as a Hypervisor Call exception, using the EC value <hexnumber>0x12</hexnumber>, and captures the value of the immediate argument, see <xref linkend=\"BEIDBEAG\">Use of the HSR</xref>.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "PSSBB":
            return {
                "tooltip": "Physical Speculative Store Bypass Barrier is a memory barrier which prevents speculative loads from bypassing earlier stores to the same physical address.",
                "html": "<p>Physical Speculative Store Bypass Barrier is a memory barrier which prevents speculative loads from bypassing earlier stores to the same physical address.</p><p>The semantics of the Physical Speculative Store Bypass Barrier are:</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "SSBB":
            return {
                "tooltip": "Speculative Store Bypass Barrier is a memory barrier which prevents speculative loads from bypassing earlier stores to the same virtual address under certain conditions.",
                "html": "<p>Speculative Store Bypass Barrier is a memory barrier which prevents speculative loads from bypassing earlier stores to the same virtual address under certain conditions.</p><p>The semantics of the Speculative Store Bypass Barrier are:</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "TSB CSYNC":
            return {
                "tooltip": "Trace Synchronization Barrier. This instruction is a barrier that synchronizes the trace operations of instructions.",
                "html": "<p>Trace Synchronization Barrier. This instruction is a barrier that synchronizes the trace operations of instructions.</p><p>If <xref linkend=\"v8.4.Trace\">FEAT_TRF</xref> is not implemented, this instruction executes as a <instruction>NOP</instruction>.</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
        ...
        case "UDF":
            return {
                ...
                "html": "<p>Permanently Undefined generates an Undefined Instruction exception.</p><p>The encodings for <instruction>UDF</instruction> used in this section are defined as permanently <arm-defined-word>undefined</arm-defined-word> in the Armv8-A architecture. However:</p>",
                "url": "https://developer.arm.com/documentation/ddi0597/2020-12/Base-Instructions/"
            };
